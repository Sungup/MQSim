...
#define All_VALID_PAGE 0x0000000000000000ULL
  ...
  */
  ...
  public:
    ...
    std::multimap<uint32_t, Block_Pool_Slot_Type*> Free_block_pool;
    ...
    uint32_t Get_free_block_pool_size();
  ...
  public:
    Flash_Block_Manager_Base(GC_and_WL_Unit_Base* gc_and_wl_unit, uint32_t max_allowed_block_erase_count, uint32_t total_concurrent_streams_no,
