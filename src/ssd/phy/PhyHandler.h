...
namespace SSD_Components {
  typedef Utils::ServiceHandlerBase<NVM_Transaction_Flash&>              TransactionServiceHandlerBase;
  ...
  template <typename T>
  using TransactionServiceHandler = Utils::ServiceHandler<T, NVM_Transaction_Flash&>;
  template <typename T>
  ...
  typedef std::vector<TransactionServiceHandlerBase*> TransactionServiceHandlerList;
