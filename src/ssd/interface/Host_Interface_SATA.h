...
#define SATA_STREAM_ID ((stream_id_type)(0))
  ...
  public:
    ...
    ~Input_Stream_SATA() final = default;
  ...
  public:
    ...
    void Handle_new_arrived_request(UserRequest* request);
    void Handle_arrived_write_data(UserRequest* request);
    void Handle_serviced_request(UserRequest* request);
  private:
    void segment_user_request(UserRequest* user_request);
    void inform_host_request_completed(UserRequest* request);
    uint16_t ncq_depth;
  };
  ...
  public:
    ...
    void Fetch_write_data(UserRequest* request);
    void Send_read_data(UserRequest* request);
    void Send_completion_queue_element(UserRequest* request, uint16_t ncq_head_value);
