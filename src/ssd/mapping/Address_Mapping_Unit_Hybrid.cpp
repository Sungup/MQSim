...
namespace SSD_Components
{
  ...
  void Address_Mapping_Unit_Hybrid::Execute_simulator_event(MQSimEngine::SimEvent* event) {}
  ...
  void Address_Mapping_Unit_Hybrid::Translate_lpa_to_ppa_and_dispatch(const std::list<NvmTransaction*>& transaction_list) {}
  ...
  bool Address_Mapping_Unit_Hybrid::query_cmt(NvmTransactionFlash* transaction) { return true; }
  ...
  void Address_Mapping_Unit_Hybrid::Allocate_new_page_for_gc(NvmTransactionFlashWR* transaction, bool is_translation_page) {}
  ...
  void Address_Mapping_Unit_Hybrid::manage_user_transaction_facing_barrier(NvmTransactionFlash* transaction) {}
