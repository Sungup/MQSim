...
namespace SSD_Components
{
  NVM_Transaction_Flash_WR::NVM_Transaction_Flash_WR(Transaction_Source_Type source, stream_id_type stream_id,
    uint32_t data_size_in_byte, LPA_type lpa, PPA_type ppa, const NVM::FlashMemory::Physical_Page_Address& address, SSD_Components::UserRequest* user_io_request, NVM::memory_content_type content,
  ...
  NVM_Transaction_Flash_WR::NVM_Transaction_Flash_WR(Transaction_Source_Type source, stream_id_type stream_id,
    uint32_t data_size_in_byte, LPA_type lpa, PPA_type ppa, SSD_Components::UserRequest* user_io_request, NVM::memory_content_type content,
    NVM_Transaction_Flash_RD* related_read, page_status_type written_sectors_bitmap, data_timestamp_type data_timestamp) :
  ...
  NVM_Transaction_Flash_WR::NVM_Transaction_Flash_WR(Transaction_Source_Type source, stream_id_type stream_id,
    uint32_t data_size_in_byte, LPA_type lpa, SSD_Components::UserRequest* user_io_request, NVM::memory_content_type content,
