...
uint32_t Device_Parameter_Set::Data_Cache_Capacity = 1024 * 1024 * 512;//Data cache capacity in bytes
uint32_t Device_Parameter_Set::Data_Cache_DRAM_Row_Size = 8192;//The row size of DRAM in the data cache, the unit is bytes
uint32_t Device_Parameter_Set::Data_Cache_DRAM_Data_Rate = 800;//Data access rate to access DRAM in the data cache, the unit is MT/s
uint32_t Device_Parameter_Set::Data_Cache_DRAM_Data_Busrt_Size = 4;//The number of bytes that are transferred in one burst (it depends on the number of DRAM chips)
...
uint32_t Device_Parameter_Set::CMT_Capacity = 2 * 1024 * 1024;//Size of SRAM/DRAM space that is used to cache address mapping table in bytes
...
uint32_t Device_Parameter_Set::Static_Wearleveling_Threshold = 100;
...
uint32_t Device_Parameter_Set::Flash_Channel_Count = 8;
uint32_t Device_Parameter_Set::Flash_Channel_Width = 1;//Channel width in byte
