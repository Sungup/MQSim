...
namespace NVM
{
  namespace FlashMemory
  {
    ...
    public:
      ...
      explicit Physical_Page_Address(const flash_channel_ID_type channel_id = 0,
    ...
    force_inline std::ostream&
    operator<<(std::ostream& os, const Physical_Page_Address& obj)
    {
      os << "PPA[" << obj.ChannelID << "]"
         << "[" << obj.ChipID << "]"
         << "[" << obj.DieID << "]"
         << "[" << obj.PlaneID << "]"
         << "[" << obj.BlockID << "]"
